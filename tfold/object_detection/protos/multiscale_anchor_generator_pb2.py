...
# source: tfold.object_detection/protos/multiscale_anchor_generator.proto
...
_MULTISCALEANCHORGENERATOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='scales_per_octave', full_name='object_detection.protos.MultiscaleAnchorGenerator.scales_per_octave',
            index=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MultiscaleAnchorGenerator.normalize_coordinates', index=5,

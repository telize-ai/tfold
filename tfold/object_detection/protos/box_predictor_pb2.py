...
# source: tfold.object_detection/protos/box_predictor.proto
...
_BOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.BoxPredictor.weight_shared_convolutional_box_predictor', index=3,
...
_MASKHEAD = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='masks_are_class_agnostic', full_name='object_detection.protos.MaskHead.masks_are_class_agnostic',
            index=2,
...
_WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.conv_hyperparams', index=0,
            number=1, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='kernel_size', full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.kernel_size',
            index=3,
            number=7, type=5, cpp_type=1, label=1,
        ...
        _descriptor.FieldDescriptor(
            name='box_code_size',
            full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.box_code_size', index=4,
            number=8, type=5, cpp_type=1, label=1,
            has_default_value=True, default_value=4,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='use_dropout', full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.use_dropout',
            index=6,
            number=11, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            name='dropout_keep_probability',
            full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.dropout_keep_probability', index=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.share_prediction_tower', index=8,
        ...
        _descriptor.FieldDescriptor(
            name='use_depthwise',
            full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.use_depthwise', index=9,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='mask_head', full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.mask_head',
            index=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.WeightSharedConvolutionalBoxPredictor.score_converter', index=11,
...
_MASKRCNNBOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MaskRCNNBoxPredictor.mask_prediction_num_conv_layers', index=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MaskRCNNBoxPredictor.masks_are_class_agnostic', index=11,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MaskRCNNBoxPredictor.share_box_across_classes', index=12,
            number=13, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MaskRCNNBoxPredictor.convolve_then_upsample_masks', index=13,
            number=14, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_BOXPREDICTOR.fields_by_name[
    'weight_shared_convolutional_box_predictor'].message_type = _WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR
...
_BOXPREDICTOR.fields_by_name['weight_shared_convolutional_box_predictor'].containing_oneof = \
...
_WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR.fields_by_name[
    'box_encodings_clip_range'].message_type = _WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR_BOXENCODINGSCLIPRANGE
...
WeightSharedConvolutionalBoxPredictor = _reflection.GeneratedProtocolMessageType(
    'WeightSharedConvolutionalBoxPredictor', (_message.Message,), dict(

...
from tfold.object_detection.core import data_decoder
from tfold.object_detection.core import standard_fields as fields
from tfold.object_detection.protos import input_reader_pb2
from tfold.object_detection.utils import label_map_util
    ...
    def __init__(self,
        ...
        Args:
          ...
          label_map_proto_file: a file path to a
            tfold.object_detection.protos.StringIntLabelMap proto. If provided, then the

...
from tfold.object_detection.protos import eval_pb2
from tfold.object_detection.protos import graph_rewriter_pb2
...
from tfold.object_detection.protos import train_pb2

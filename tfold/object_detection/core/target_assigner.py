...
from tfold.object_detection.core import box_coder as bcoder
from tfold.object_detection.core import box_list
from tfold.object_detection.core import matcher as mat
from tfold.object_detection.core import region_similarity_calculator as sim_calc
from tfold.object_detection.core import standard_fields as fields
from tfold.object_detection.matchers import argmax_matcher
from tfold.object_detection.matchers import bipartite_matcher
from tfold.object_detection.utils import shape_utils
...
class TargetAssigner(object):
    ...
    def __init__(self,
        ...
        Args:
          ...
          matcher: an tfold.object_detection.core.Matcher used to match groundtruth to
            anchors.
          box_coder: an tfold.object_detection.core.BoxCoder used to encode matching
